<?php
/**
 * PricePrawl Search Functions
 * Shared functions for URL processing and product identification
 */
        ...
        case 111: // Myntra
            {
                ...
                if (includesString($r, "myntra.com/")) {
                    $matches = [];
                    if (preg_match('/\/([0-9]+)\/buy$/', $r, $matches)) {
                        $r = $matches[1];
                    } else {
...
$posExtractionRules = [
    ...
    ['domainPattern' => "bluestone.com", 'pos' => 426],
    ['domainPattern' => "pepperfry.com", 'pos' => 333],
